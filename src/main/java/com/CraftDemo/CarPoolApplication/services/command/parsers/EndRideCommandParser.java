...
public class EndRideCommandParser implements CommandParser<EndRideRequest> {

    private static final Integer expectedArguments = 6;
    @Override
    public EndRideRequest parseCommand(String input) throws CommandParsingException {
        ...
        return new EndRideRequest(userName,vehicleName,regNo,origin,destination,seats);
    }
}
